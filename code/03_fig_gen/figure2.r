...
ggsave("plots/figure2a.pdf", width = 8, height = 5)
plot_shapley(shap_30_private, "30m private")
ggsave("plots/figure2b.pdf", width = 8, height = 5)
plot_shapley(shap_30_public, "30m public")
ggsave("plots/figure2c.pdf", width = 8, height = 5)
plot_shapley(shap_30_balanced, "30m balanced")
ggsave("plots/figure2d.pdf", width = 8, height = 5)

plot_shapley(shap_180_overall, "180m overall")
ggsave("plots/figure2e.pdf", width = 8, height = 5)
plot_shapley(shap_180_private, "180m private")
ggsave("plots/figure2f.pdf", width = 8, height = 5)
plot_shapley(shap_180_public, "180m public")
ggsave("plots/figure2g.pdf", width = 8, height = 5)
plot_shapley(shap_180_balanced, "180m balanced")
ggsave("plots/figure2h.pdf", width = 8, height = 5)
