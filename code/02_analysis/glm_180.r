...
saveRDS(naive_model, "data/model_objects/naive_model_structure_180.rds")
...
bb
saveRDS(bb, "data/autocor_scale_m_180.rds")

bb <- readRDS("data/autocor_scale_m_180.rds")
...
save.image(file = "bsd180.Rdata")
## then run external file (contents below)
source("code/02_analysis/run_bootstrap_180.R")
