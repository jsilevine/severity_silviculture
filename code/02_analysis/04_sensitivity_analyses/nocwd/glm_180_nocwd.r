...
bb <- readRDS("data/autocor_scale/autocor_scale_m_180.rds")
...
write.csv(bs.coefs, file = "data/bootstraps/bootstrap_coefs_180_nocwd.csv")

## this is the janky way to force R to restart after each iteration
## first save workspace image
save.image(file = "bsd180_nocwd.Rdata")
## then run external file (contents below)
source("code/02_analysis/04_sensitivity_analyses/nocwd/run_bootstrap_180_nocwd.R")
