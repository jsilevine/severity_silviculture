...
br_own <- read.csv("data/bootstraps/bootstrap_coefs_ownership_nocwd.csv")
...
write.csv(results_summary, "data/model_objects/ownership_nocwd_summary.csv", row.names = FALSE)



br_30 <- read.csv("data/bootstraps/bootstrap_coefs_30_nocwd.csv")
...
write.csv(results_summary_30, "data/model_objects/30_nocwd_summary.csv", row.names = FALSE)


br_180 <- read.csv("data/bootstraps/bootstrap_coefs_180_nocwd.csv")
...
write.csv(results_summary_180, "data/model_objects/180_nocwd_summary.csv", row.names = FALSE)
